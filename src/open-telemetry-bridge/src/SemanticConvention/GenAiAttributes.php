...
final class GenAiAttributes
{
    ...
    // Core semconv, read by Langfuse and Arize Phoenix as the user of the trace
     ...
     */
    public static function finishReason(FinishReason $finishReason): string
    {
        return str_replace('-', '_', $finishReason->getCase()->value);
    }
