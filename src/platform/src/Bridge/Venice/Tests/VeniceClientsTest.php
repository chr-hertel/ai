...
use Symfony\AI\Platform\Bridge\Venice\ImageEditClient;
...
final class VeniceClientsTest extends TestCase
{
    ...
    public function testClientCanTriggerTextToVideoAndPollUntilReady()
    {
        ...
        $clock = new MockClock();
        $client = new VideoGenerationClient($httpClient, $clock);
    ...
    public function testClientCanTriggerImageToVideoWithAspectRatioOverride()
    {
        ...
        $client = new VideoGenerationClient($httpClient, new MockClock());
    ...
    public function testNoClientAcceptsAnUnsupportedCapability()
    {
        $httpClient = new MockHttpClient([], 'https://api.venice.ai/api/v1/');
        $model = new Venice('unknown-model', [Capability::INPUT_TEXT]);

        foreach ([
            new VideoGenerationClient($httpClient),
    ...
    public function testClientCanTriggerImageEdit()
    {
        ...
        $client = new ImageEditClient($httpClient);
