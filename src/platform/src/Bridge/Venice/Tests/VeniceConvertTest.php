...
use Symfony\AI\Platform\Bridge\Venice\AbstractVeniceClient;
use Symfony\AI\Platform\Bridge\Venice\ChatCompletionsClient;
use Symfony\AI\Platform\Bridge\Venice\EmbeddingsClient;
use Symfony\AI\Platform\Bridge\Venice\ImageGenerationClient;
use Symfony\AI\Platform\Bridge\Venice\SpeechToTextClient;
use Symfony\AI\Platform\Bridge\Venice\TextToSpeechClient;
use Symfony\AI\Platform\Bridge\Venice\VideoGenerationClient;
...
final class VeniceConvertTest extends TestCase
{
    public function testConvertCompletionToTextResult()
    {
        ...
        $converter = self::client(ChatCompletionsClient::class);
    ...
    public function testConvertSpeechToBinaryResult()
    {
        ...
        $converter = self::client(TextToSpeechClient::class);
        $converted = $converter->convert($result);
    ...
    public function testConvertEmbeddingsToVectorResult()
    {
        ...
        $converter = self::client(EmbeddingsClient::class);
        $converted = $converter->convert($result);
    ...
    public function testConvertImageGenerationToBinaryResult()
    {
        ...
        $converter = self::client(ImageGenerationClient::class);
        $converted = $converter->convert($result);
    ...
    public function testConvertCompletionWithToolCalls()
    {
        ...
        $response = $httpClient->request('POST', 'chat/completions');
        $converted = self::client(ChatCompletionsClient::class)->convert(new RawHttpResult($response));
    ...
    public function testConvertCompletionWithoutContentThrows()
    {
        ...
        self::client(ChatCompletionsClient::class)->convert(new RawHttpResult($response));
    }
    ...
    public function testConvertTranscriptionToTextResult()
    {
        ...
        $converted = self::client(SpeechToTextClient::class)->convert(new RawHttpResult($response));
    ...
    public function testConvertTranscriptionMissingTextThrows()
    {
        ...
        self::client(SpeechToTextClient::class)->convert(new RawHttpResult($response));
    }
    ...
    public function testConvertVideoRetrieveToBinary()
    {
        ...
        $converted = self::client(VideoGenerationClient::class)->convert(new RawHttpResult($response));
    ...
    public function testConvertImageGenerationWithMultipleImagesReturnsChoiceResult()
    {
        ...
        $response = $httpClient->request('POST', 'image/generate');
        $converted = self::client(ImageGenerationClient::class)->convert(new RawHttpResult($response));
    ...
    public function testConvertImageGenerationMissingImagesThrows()
    {
        ...
        self::client(ImageGenerationClient::class)->convert(new RawHttpResult($response));
    }
    ...
    public function testConvertEmbeddingsMissingDataThrows()
    {
        ...
        self::client(EmbeddingsClient::class)->convert(new RawHttpResult($response));
    }
    ...
    public function testConvertStreamingWithReasoningAndToolCalls()
    {
        ...
        $result = new InMemoryRawResult([], $streamData, $response);
        $converted = self::client(ChatCompletionsClient::class)->convert($result, ['stream' => true]);
    ...
    /**
     * @param class-string<AbstractVeniceClient> $client
     */
    private static function client(string $client): AbstractVeniceClient
    {
        return new $client(new MockHttpClient([], 'https://api.venice.ai/api/v1/'));
    }
}
