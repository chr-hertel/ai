...
/**
 * Self-contained handler for the OpenAI Embeddings endpoint.
 *
...
final class EndpointHandler extends AbstractModelClient implements EndpointHandlerInterface
{
    ...
    {
        $rawResult = new RawHttpResult($this->httpClient->request('POST', self::getBaseUrl($this->region).'/v1/embeddings', [
