...
use Symfony\AI\Platform\Bridge\Together\ChatCompletionsClient;
use Symfony\AI\Platform\Bridge\Together\EmbeddingsClient;
use Symfony\AI\Platform\Bridge\Together\ImageGenerationClient;
use Symfony\AI\Platform\Bridge\Together\RerankClient;
use Symfony\AI\Platform\Bridge\Together\TextToSpeechClient;
use Symfony\AI\Platform\Bridge\Together\Together;
use Symfony\AI\Platform\Bridge\Together\TranscriptionClient;
 ...
 */
final class TogetherClientsTest extends TestCase
{
    public function testItIsSupportingTheCorrectModel()
    {
        $client = new ChatCompletionsClient(new MockHttpClient());

        $this->assertTrue($client->supports(new Together('openai/gpt-oss-120b', [Capability::INPUT_MESSAGES])));
    }
    ...
    public function testItDoesNotSupportOtherModels()
    {
        ...
        $this->assertFalse($client->supports(new Together('openai/gpt-oss-120b', [Capability::EMBEDDINGS])));
    }
    ...
    public function testItIsExecutingTheCompletionsRequest()
    {
        ...
        $client = new ChatCompletionsClient($httpClient);
        $client->request(
    ...
    {
        $client = new ChatCompletionsClient(new MockHttpClient([], 'https://api.together.xyz'));
    ...
    public function testItIsExecutingTheImageGenerationRequest()
    {
        ...
        $httpClient = new MockHttpClient($resultCallback, 'https://api.together.xyz');
        $client = new ImageGenerationClient($httpClient);
        $client->request(
    ...
    {
        $client = new TextToSpeechClient(new MockHttpClient([], 'https://api.together.xyz'));
    ...
    public function testItIsExecutingTheSpeechToTextRequest()
    {
        ...
        $httpClient = new MockHttpClient($resultCallback, 'https://api.together.xyz');
        $client = new TranscriptionClient($httpClient);
        $client->request(
    ...
    {
        $client = new TranscriptionClient(new MockHttpClient([], 'https://api.together.xyz'));
    ...
    public function testItIsExecutingTheRerankRequest()
    {
        ...
        $httpClient = new MockHttpClient($resultCallback, 'https://api.together.xyz');
        $client = new RerankClient($httpClient);
        $client->request(
    ...
    {
        $client = new RerankClient(new MockHttpClient([], 'https://api.together.xyz'));
    ...
    public function testNoClientAcceptsAModelWithoutSupportedCapability()
    {
        $httpClient = new MockHttpClient([], 'https://api.together.xyz');
        $model = new Together('some/unknown-model');
        ...
        foreach ([
            ...
            $this->assertFalse($client->supports($model), \sprintf('"%s" must not accept a model without a matching capability.', $client::class));
        }
    }
}
