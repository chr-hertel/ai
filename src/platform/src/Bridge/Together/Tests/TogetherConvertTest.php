...
use Symfony\AI\Platform\Bridge\Together\AbstractTogetherClient;
 ...
 */
final class TogetherConvertTest extends TestCase
{
    public function testSupportsTogetherModel()
    {
        $client = self::client(ChatCompletionsClient::class);

        $this->assertTrue($client->supports(new Together('moonshotai/Kimi-K2.6', [Capability::INPUT_MESSAGES])));
    }
    ...
    public function testConvertTranscriptionResponse()
    {
        ...
        $converter = self::client(TranscriptionClient::class);
    ...
    public function testConvertRerankResponse()
    {
        ...
        $converter = self::client(RerankClient::class);
    ...
    /**
     * @param class-string<AbstractTogetherClient> $client
     */
    private static function client(string $client): AbstractTogetherClient
    {
