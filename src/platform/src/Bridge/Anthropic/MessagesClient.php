 ...
 */
final class MessagesClient implements ApiClientInterface
{
    ...
    public function request(Model $model, array|string $payload, array $options = []): RawResultInterface
    {
        ...
        return $this->transport->send($model, '/v1/messages', array_merge($options, $payload), $headers);
    }
