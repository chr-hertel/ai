 ...
 * [BC BREAK] Replace the model client and result converter with `MessagesClient`, reaching the API through a `Transport\TransportInterface` (`Transport\HttpTransport`)
