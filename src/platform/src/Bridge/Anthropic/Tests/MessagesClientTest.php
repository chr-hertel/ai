...
class MessagesClientTest extends TestCase
{
    ...
    private MessagesClient $modelClient;
    ...
    public function testAnthropicBetaHeaderIsSetWithSingleBetaFeature()
    {
        ...
        $this->modelClient = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key'));
    ...
    {
        $this->modelClient = new MessagesClient(new HttpTransport(new MockHttpClient(), 'test-api-key'));
    ...
    public function testServerToolsAreAppendedAfterFunctionToolsCacheControl()
    {
        ...
        $this->modelClient = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key'), 'short');
    ...
    public function testLongCacheRetentionInjectsEphemeralWithTtl()
    {
        ...
        $this->modelClient = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key'), 'long');
    ...
    public function testCustomBaseUrlIsUsedForTheRequest()
    {
        ...
        $this->modelClient = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key', 'https://anthropic.example.com/'), 'short');
    ...
    public function testNoneCacheRetentionDoesNotInject()
    {
        ...
        $this->modelClient = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key'), 'none');
    ...
    public function testCacheControlShapeForRetentionValue(string $retention, array $expectedCacheControl)
    {
        ...
        $this->modelClient = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key'), $retention);
