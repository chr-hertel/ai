...
class MessagesClientTest extends TestCase
{
    ...
    public function testServerToolsUnknownNameThrows()
    {
        ...
        $this->client->request($this->model, ['message' => 'test'], [
    ...
    public function testServerToolsAreAppendedAfterFunctionToolsCacheControl()
    {
        ...
        $this->client = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key'), 'short');
    ...
    public function testCustomBaseUrlIsUsedForTheRequest()
    {
        ...
        $this->client = new MessagesClient(new HttpTransport($this->httpClient, 'test-api-key', 'https://anthropic.example.com/'), 'short');

        $this->client->request($this->model, ['messages' => [['role' => 'user', 'content' => 'Hello']]]);
    }
    ...
    public function testMalformedUtf8InPayloadDoesNotAbortTheRequest()
    {
        ...
        $this->client->request($this->model, [
