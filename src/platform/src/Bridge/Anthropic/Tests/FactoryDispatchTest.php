...
final class FactoryDispatchTest extends TestCase
{
    public function testInvokeRoutesThroughMessagesClient()
    {
        ...
        $result = $platform->invoke('claude-3-7-sonnet-20250219', new MessageBag(Message::ofUser('hi')));
        ...
        $this->assertSame('claude-3-7-sonnet-20250219', $capturedBody['model']);
    ...
    public function testInvokeWithUnknownEndpointThrows()
    {
        ...
        $this->expectExceptionMessageMatches('/No ModelClient registered for model "claude-3-7-sonnet-20250219"/');
