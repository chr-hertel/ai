...
{
    public function testVertexAiGenerateContentReusesGeminiClient()
    {
        $capturedUrl = null;
    ...
    public function testVertexAiUsesProjectScopedUrlWhenLocationGiven()
    {
        ...
        $this->assertStringStartsWith('https://us-central1-aiplatform.googleapis.com/v1/projects/my-project/locations/us-central1/publishers/google/models/gemini-2.5-flash:generateContent', $capturedUrl);
    }
}
