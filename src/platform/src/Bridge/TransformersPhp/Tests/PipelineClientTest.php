...
use Symfony\AI\Platform\Bridge\TransformersPhp\PipelineClient;
 ...
 */
final class PipelineClientTest extends TestCase
{
    public function testConvertText2TextGeneration()
    {
        ...
        $textResult = (new PipelineClient())->convert($result, ['task' => Task::Text2TextGeneration]);
    ...
    public function testConvertFeatureExtraction()
    {
        ...
        $vectorResult = (new PipelineClient())->convert($result, ['task' => Task::FeatureExtraction]);
