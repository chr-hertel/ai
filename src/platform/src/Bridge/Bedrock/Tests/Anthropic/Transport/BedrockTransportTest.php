...
namespace Symfony\AI\Platform\Bridge\Bedrock\Tests\Anthropic\Transport;
...
use Symfony\AI\Platform\Bridge\Bedrock\Anthropic\Transport\BedrockTransport;
use Symfony\AI\Platform\Bridge\Bedrock\RawBedrockResult;

final class BedrockTransportTest extends TestCase
{
    ...
    public function testPassesModelIdWithoutSuffix()
    {
        ...
        $this->modelClient = new MessagesClient(new BedrockTransport($this->bedrockClient, self::VERSION), 'none');
    ...
    public function testPassesModelIdWithCustomOverride()
    {
        ...
        $this->modelClient = new MessagesClient(new BedrockTransport(
            $this->bedrockClient,
            self::VERSION,
