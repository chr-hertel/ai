...
final class SpeakClientTest extends TestCase
{
    ...
    public function testSupportsOnlySpeakEndpoint()
    {
        ...
        $this->assertTrue($client->supports(new Deepgram('aura-2-thalia-en', [Capability::TEXT_TO_SPEECH])));
        $this->assertFalse($client->supports(new Deepgram('nova-3', [Capability::SPEECH_TO_TEXT])));
