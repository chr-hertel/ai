...
final class RequestEnvelope
{
     ...
     * @param string|null                        $body    Pre-encoded body, sent verbatim instead of $payload.
     *                                                    Set it when the contract needs an encoding the transport
     *                                                    cannot produce (e.g. multipart carrying a MIME type).
     */
