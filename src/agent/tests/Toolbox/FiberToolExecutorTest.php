...
final class FiberToolExecutorTest extends TestCase
{
    public function testExecuteReturnsEmptyArrayForNoToolCalls()
    {
        ...
        $executor = new FiberToolExecutor($invoker);

        $this->assertSame([], $executor->execute([]));
    }

    public function testExecuteCallsInvokerOncePerToolCall()
    {
    ...
    public function testExecutePreservesOrderOfResults()
    {
        ...
        $invoker = $this->createStub(ToolInvokerInterface::class);
        $invoker
            ->method('execute')
    ...
    public function testExecuteHandlesFiberSuspension()
    {
        ...
        $executor = new FiberToolExecutor($invoker);
        $results = $executor->execute([$toolCall]);
    ...
    public function testRoundRobinSchedulingInterleavesFibers()
    {
        ...
        $executor = new FiberToolExecutor($invoker);
        $results = $executor->execute([$toolCallA, $toolCallB]);
    ...
    public function testExecutePropagatesInvokerExceptions()
    {
